...
export default function WebpToJpgPage() {
    ...
    reader.onload = (e) => {
      ...
      img.onload = () => {
        try {
          ...
          // Fill transparency with solid white
  ...
  const toolFAQs = [
    {
      question: 'Why convert from WebP to JPG?',
      answer: 'While WebP is an incredible, modern lightweight image format, older devices, older web designs, or native software editors may not fully support opening WebP files. Converting to JPG guarantees maximum compatibility.'
    },
    {
      question: 'How is transparency preserved?',
      answer: 'JPEG doesn’t support alpha transparencies. To maintain a professional output, any transparent sections of your WebP file will be replaced with clean white fill.'
    },
    {
      question: 'Are there file size changes?',
      answer: 'Yes, JPEG files are typically slightly larger than WebP files due to WebP’s highly superior modern compression algorithms.'
    }
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <ToolHeader
        ...
        description="Convert modern WebP images into universally compatible JPG files. Supports custom JPEG quality sliders."
          ...
          <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-900 p-6 rounded-2xl shadow-sm">
            {!file ? (
              <FileDropzone
                ...
                descriptionText="Upload a WebP image to convert"
              />
            ) : (
              <div className="space-y-6">
                ...
                {error && (
                  <p id="webp-to-jpg-error" className="text-sm text-red-600 font-semibold mt-2 text-center">
                    {error}
                  </p>
                )}
              </div>
